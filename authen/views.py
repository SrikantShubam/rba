...
def home(request):
    ...
    #username end-------------------------------------
            ...
            data=data_collected(userid=username,ip=ip_address,browser_fonts=browser_fonts,system_fonts=sys_fonts,language=lang,time_zone =local_timezone,date=naive_datetime.date(),time_collected=time_collected,city=city,region=region,country=country,browser_name=browser_ua.family, browser_version =browser_ua.version_string,os_family=system_ua.family,os_version=system_ua.version_string,screensize=screensize,plugins=plugins,canvas=canvas,webgl=webgl,ua_totaltime=ua_totaltime,ip_totaltime=final_ip,timezone_totaltime=final_timezone,location_totaltime=location_totaltime,screensize_totaltime=screen_totaltime,system_fonts_totaltime=fonts_totaltime, browser_fonts_totaltime=browser_totaltime,plugins_totaltime=plugins_totaltime,canvas_totaltime=canvas_totaltime,webgl_totaltime=webgl_totaltime,lang_totaltime=lang_totaltime,overall_totaltime=overall_totaltime)
            data.save()
    except:
        pass        
